...
#[test]
fn solve_cholesky_2x2_hand_computed() {
    // Solve [4 2; 2 3] * x = [8; 7]
    // By hand: det = 12-4 = 8
...
#[test]
fn solve_cholesky_3x3_identity() {
...
#[test]
fn cholesky_falls_back_to_lu_for_non_positive_definite() {
