//! Vector backends for the Gaussian batch kernels, and the dispatch between them.
//!
...
/// Coefficients the two backends' `exp` approximations share.
#[cfg(any(target_arch = "x86_64", target_arch = "aarch64"))]
pub(super) mod exp_poly;
