...
impl FlattenMap {
    ...
    pub(super) fn push_exposed(&mut self, instance: NodeId, producer: ExecutionNodeId) {
    ...
    pub(super) fn push_scope(&mut self, instance: NodeId, parent: u32) -> u32 {
...
pub(crate) mod internals {
    ...
    /// wrapping it, which is why the map's own writers stay inside this
    /// module's subtree.
    #[derive(Debug)]
